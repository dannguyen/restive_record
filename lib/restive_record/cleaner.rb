...
#     # Returns a hash of versions grouped by the `item_id` attribute formatted like this: {:item_id => RestiveRecord::Version}.
...
#       versions = item_id ? RestiveRecord::Version.where(:item_id => item_id) : RestiveRecord::Version
